...
func parsePublicKey(algo PublicKeyAlgorithm, keyData *publicKeyInfo) (interface{}, error) {
	...
	case BLS:
		...
		return PubKeyFromBytes(keyData.PublicKey.Bytes)
	default:
		return nil, nil
	}
}
...
func parseCertificate(in *certificate) (*Certificate, error) {
	...
	out.SignatureAlgorithm = BLSWithSHA256
	...
	//	return nil, err
	//}
	out.PublicKey,_ = PubKeyFromBytes(in.TBSCertificate.PublicKey.PublicKey.Bytes)
